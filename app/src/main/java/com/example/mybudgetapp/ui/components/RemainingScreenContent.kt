...
@Composable
fun RemainingScreenContent(mainCategoryViewModel: MainCategoryViewModel, subCategoryViewModel: SubCategoryViewModel) {
                ...
                Column(
                    ...
                    category.subCategories.forEach {  subCat ->
                        Row(
                            ...
                            Text(text = subCat.remainingAmount.toString(), fontSize = 15.sp)
                        }
